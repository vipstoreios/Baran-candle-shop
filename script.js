...
Supabase Products + Product Images + Realtime
Badini / Sorani / Arabic / English
========================================================= */
...
‘eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzIiwicmVmIjoib3lhY3pwdXRpcnN4Zm1waG5sc2giLCJyb2xlIjoiYW5vbiIsImlhdCI6MTc4ODI1NDQ3NSwiZXhwIjoyMTAzODMwNDc1fQ.fiOo-DfZAHC2vhge9W4_IAbIEVDsP3xtSFkHFgHXE0M’;
...
let lang =
localStorage.getItem(‘baran-language’) ||
‘badini’;

if (![‘badini’, ‘sorani’, ‘arabic’, ‘english’].includes(lang)) {
lang = ‘badini’;
}
...
announcement:
    'گەهاندنا خێرا بۆ هەمی ناڤچەیێن کوردستان ✦',
navHome:
    'سەرەکی',
navShop:
    'بەرهەم',
...
heroEyebrow:
    'ب دەست و خۆشەویستی',
heroTitle:
    'رۆناهییەک بۆ<br><em>هەر ساتەکێ.</em>',
heroText:
...
ourStory:
    'چیرۆکا باران',
storyTitle:
    'ژ دڵێ هاتیە دروستکرن.<br><em>بۆ مالا تە.</em>',
storyText:
...
ritualTitle:
    'دەمێ مۆم دسوژیت،<br><em>دەم کەمەک راوەستیت.</em>',
ritualText:
...
value1:
    'مومێکی پاک',
value1p:
    'Soy Wax و Beeswax ب هەڵبژاردنەکا ورد.',
value2:
    'بۆنەکا تایبەت',
value2p:
    'بۆنێن هاوسەنگ بۆ هەستەکا قووڵتر.',
value3:
    'پەکەجینگا جوان',
value3p:
    'ئامادەیە بۆ تە یان کەسەکێ تە خۆش.',
value4:
    'دروستکریا ناڤخۆ',
value4p:
    'ب دەست دروستکری ل کوردستان.',
newsletterTitle:
    'بەهارا بۆنێن خۆ ل دەست مەدە.',
newsletterText:
...
announcement:
    'گەیاندنی خێرا بۆ هەموو ناوچەکانی کوردستان ✦',
navHome:
    'سەرەکی',
navShop:
    'بەرهەمەکان',
...
heroEyebrow:
    'بە دەست و خۆشەویستی',
heroTitle:
    'ڕووناکییەک بۆ<br><em>هەموو ساتێک.</em>',
heroText:
...
ourStory:
    'چیرۆکی باران',
storyTitle:
    'لە دڵەوە دروستکراوە.<br><em>بۆ ماڵەوەی تۆ.</em>',
storyText:
...
ritualTitle:
    'کاتێک مۆم دەسووتێت،<br><em>کات کەمێک وەستێت.</em>',
ritualText:
...
value1:
    'مومی پاک',
value1p:
    'Soy Wax و Beeswax بە هەڵبژاردنی ورد.',
value2:
    'بۆنی تایبەت',
value2p:
    'بۆنە هاوسەنگەکان بۆ هەستی قووڵتر.',
value3:
    'پەکەجینگی جوان',
value3p:
    'ئامادەیە بۆ خۆت یان کەسێکی خۆشەویست.',
value4:
    'دروستکراوی ناوخۆ',
value4p:
    'بە دەست دروستکراو لە کوردستان.',
newsletterTitle:
    'بەهاری بۆنەکانت لەدەست مەدە.',
newsletterText:
...
announcement:
    'توصيل سريع إلى جميع أنحاء العراق ✦',
navHome:
    'الرئيسية',
navShop:
    'المنتجات',
...
value1:
    'شمع نقي',
value1p:
    'شمع الصويا وشمع العسل باختيار دقيق.',
value2:
    'عطر مميز',
value2p:
    'نفحات متوازنة لشعور أعمق.',
value3:
    'تغليف أنيق',
value3p:
    'جاهز لك أو لمن تحب.',
value4:
    'صناعة محلية',
value4p:
    'مصنوع يدوياً في كردستان.',
newsletterTitle:
    'لا تفوّت مواسم العطر.',
newsletterText:
...
announcement:
    'Fast delivery across Iraq & Kurdistan ✦',
navHome:
    'Home',
navShop:
    'Shop',
...
ourStory:
    'The Baran story',
storyTitle:
    'Made from the heart.<br><em>For your home.</em>',
storyText:
...
ritualTitle:
    'When a candle burns,<br><em>time slows down.</em>',
ritualText:
...
value1:
    'Pure wax',
value1p:
    'Soy Wax and Beeswax, carefully selected.',
value2:
    'Signature scent',
value2p:
    'Balanced notes for a deeper feeling.',
value3:
    'Beautiful packaging',
value3p:
    'Ready for you or someone you love.',
value4:
    'Locally made',
value4p:
    'Hand-poured in Kurdistan.',
newsletterTitle:
    'Never miss a season of scent.',
newsletterText:
...
if (
    product?.burn_time_minutes !== null &&
    product?.burn_time_minutes !== undefined &&
    Number(product.burn_time_minutes) > 0
) {
    parts.push(
