/* =========================================================
   BARAN CANDLE SHOP — Storefront Runtime
   Supabase products + real images + Kurdish/Arabic/English
   ========================================================= */
...
wicmVmIjoib3lhY3pwdXRpcnN4Zm1waG5sc2giLCJyb2xlIjoiYW5vbiIsImlhdCI6
MTc4ODI1NDQ3NSwiZXhwIjoyMTAzODMwNDc1fQ.fiOo-DfZAHC2vhge9W4_IAbIEVDsP3xtSFkHFgHXE0M';
...
sorani: {
    ...
    storyText:
    'هەر مۆمێکی Baran بە دەست دروست دەکرێت، بە مومێکی باش و بۆنی هاوسەنگ.',
...
arabic: {
    ...
    storyText:
    'كل شمعة من Baran مصنوعة يدوياً من شمع مختار بعناية وعطور متوازنة.',
...
english: {
    ...
    storyText:
    'Every Baran candle is hand-poured with carefully selected wax and balanced fragrance.',
...
let cart =
    JSON.parse(localStorage.getItem('baran-cart') || '[]');
...
function renderText() {
    ...
    Object.entries(hard).forEach(([selector, map]) => {

        const element = $(selector);

        if (element && map[lang] !== undefined) {
            element.innerHTML = map[lang];
        }
    });
    ...
    if (badge) {
        badge.textContent = tr('collectionBadge');
    }
