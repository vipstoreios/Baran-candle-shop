-- BARAN CANDLE SHOP — Admin CMS content table
-- Run this file once in Supabase SQL Editor.
-- It does NOT alter products, orders, customers, or auth passwords.
...
create policy "public read active site content" on public.site_content
...
-- Verify only; no data mutation beyond the CMS table above.
select count(*) as seeded_content_keys from public.site_content;
